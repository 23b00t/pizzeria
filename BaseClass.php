 ...
 * getters and setters by populating protected static arrays $noGetters and $noSetters.
 *
 ...
 *
 * - $noGetters: List of disallowed getter methods.
 * - $noSetters: List of disallowed setter methods.
 *
 * Methods:
 * 
 * @method mixed __call(string $func, array $params) Dynamically handles getter and setter calls for class properties.
 * @throws BadMethodCallException If the method or property is disallowed or does not exist.
 *
 * Private Methods:
 * @method static void checkDissallowed(string $func, array $exceptions) Checks if a method is disallowed and throws an exception if it is.
 */
...
class BaseClass
{
	...
	// Private function is not inherited to child class. It is only used here in BaseClass.
